...
const DEFAULT_COLUMNS = [
  ...
  { key: 'pricePerBuyingUnit', label: 'Price/Buying Unit', cls: 'col-perunit desktop-only' },
  ...
  { key: 'pricePerCostingUnit',  label: 'Price/Costing Unit', cls: 'col-percost desktop-only' },
